      ...
      <div className="relative w-full h-full mt-[50px] vsm:mt-[100px] px-[20px] xl:px-[60px] flex flex-col md:flex-row gap-[56px] md:gap-0 justify-between">
        ...
        <div className="w-[85%] vsm:w-[60%] md:w-[28%] xl:w-[30%] md:self-end">
          ...
          <p className="mt-[20px] text-[13px] xl:text-base opacity-60 leading-7">
            Paradise Club Hotel opened its doors in 1995, offering guests an authentic Hawaiian 
            experience with modern luxury. Our beachfront location, surrounded by swaying palm trees 
            and turquoise waters, provides the perfect setting for unforgettable tropical getaways.
          </p>
        </div>
