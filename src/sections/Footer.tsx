...
const Footer = ({ whiteBg }: FooterPropType) => {
  ...
  return (
    ...
    >
      ...
      >
        123 Paradise Beach <br /> Road, Maui
      </p>
      ...
      >
        <div>
          ...
          <p className="mt-[10px] md:mt-[40px] mb-[10px] md:mb-[70px] w-[285px] opacity-80 text-base leading-7">
            Paradise Club Hotel offers the ultimate tropical escape with beachfront 
            luxury, world-class dining, and authentic Hawaiian hospitality in paradise.
          </p>
          <div className="opacity-25 text-sm">
            ©2023 All rights reserved. Paradise Club Hotel
          </div>
        </div>
        ...
        <div>
          ...
          <p className="mt-[10px] md:mt-[40px] mb-[10px] md:mb-[70px] w-[285px] opacity-80 text-base leading-7">
            Sign up to our newsletter for exclusive tropical offers, special events, 
            and insider tips for your perfect Hawaiian getaway.
          </p>
