...
const Booking = () => {
  ...
  const handleSubmit = (e: any) => {
    e.preventDefault();
    alert(`Aloha ${username}! Your tropical paradise getaway has been successfully booked. Mahalo!`);
    ...
    >
      ...
      >
        ...
        <p className="text-center">
          Book your tropical paradise now and experience{" "}
          <span className="font-Miracle">Hawaiian luxury.</span>
        </p>
        <form
